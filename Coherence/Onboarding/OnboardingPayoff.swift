    ...
    var body: some View {
        OnboardingScreen(section: phase == .start ? .cost : .win,
            ...
            VStack(alignment: .leading, spacing: 11) {
                ...
                if phase == .start {
                    panel(name: "Your heart", tint: AppColor.calmAccent,
                          value: "72 → 84 bpm · climbing",
                          points: [72, 72.4, 73.2, 73, 74.6, 76, 77.2, 78.6, 80.2, 82, 84],
                          domain: 63...93, lineTint: AppColor.calmAccentFill)
