...
receives and stores a unique Apple user identifier, and — only if you choose to
share them — your **name** and **email address** (which may be an Apple private
"Hide My Email" relay address). You may also set a display name and choose whether
to receive product emails.
...
and marks your account for deletion; your account and all associated data are then
permanently removed within **30 days**. Signing back in before then restores it.
You can also delete the app; to remove synced data, delete the app's data from
